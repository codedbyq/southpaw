...
export default function UploadButton() {
  ...
  async function handleFileChange(e) {
    ...
    try {
      ...
      // Using XMLHttpRequest instead of fetch so we get upload progress events
      ...
      console.log('Upload complete — job_id:', job_id)
      setState('complete')
  ...
  return (
    <div>
      ...
      {state === 'complete' && (
        <p className="mt-2 text-sm text-green-400">Upload complete — processing started</p>
      )}
    </div>
  )
}
